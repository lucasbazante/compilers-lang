...
inline ParseTable build_parse_table() {
	...
	table[static_cast<size_t>(Rule::PROC_DECLS_OPT)][static_cast<size_t>(Token::In)] = SymbolSequence{Token::In, };
	...
	table[static_cast<size_t>(Rule::STMT_LIST)][static_cast<size_t>(Token::Identifier)] = SymbolSequence{Rule::STMT, Rule::STMT_LIST_TAIL, };
	table[static_cast<size_t>(Rule::STMT_LIST)][static_cast<size_t>(Token::End)] = SymbolSequence{};
	table[static_cast<size_t>(Rule::STMT_LIST)][static_cast<size_t>(Token::L_Paren)] = SymbolSequence{Rule::STMT, Rule::STMT_LIST_TAIL, };
	table[static_cast<size_t>(Rule::STMT_LIST)][static_cast<size_t>(Token::New)] = SymbolSequence{Rule::STMT, Rule::STMT_LIST_TAIL, };
	table[static_cast<size_t>(Rule::STMT_LIST)][static_cast<size_t>(Token::Ref)] = SymbolSequence{Rule::STMT, Rule::STMT_LIST_TAIL, };
	table[static_cast<size_t>(Rule::STMT_LIST)][static_cast<size_t>(Token::Deref)] = SymbolSequence{Rule::STMT, Rule::STMT_LIST_TAIL, };
	table[static_cast<size_t>(Rule::STMT_LIST)][static_cast<size_t>(Token::Float_L)] = SymbolSequence{Rule::STMT, Rule::STMT_LIST_TAIL, };
	table[static_cast<size_t>(Rule::STMT_LIST)][static_cast<size_t>(Token::Int_L)] = SymbolSequence{Rule::STMT, Rule::STMT_LIST_TAIL, };
	table[static_cast<size_t>(Rule::STMT_LIST)][static_cast<size_t>(Token::String_L)] = SymbolSequence{Rule::STMT, Rule::STMT_LIST_TAIL, };
	table[static_cast<size_t>(Rule::STMT_LIST)][static_cast<size_t>(Token::Bool_L)] = SymbolSequence{Rule::STMT, Rule::STMT_LIST_TAIL, };
	table[static_cast<size_t>(Rule::STMT_LIST)][static_cast<size_t>(Token::Null)] = SymbolSequence{Rule::STMT, Rule::STMT_LIST_TAIL, };
	table[static_cast<size_t>(Rule::STMT_LIST)][static_cast<size_t>(Token::If)] = SymbolSequence{Rule::STMT, Rule::STMT_LIST_TAIL, };
	...
	table[static_cast<size_t>(Rule::STMT_LIST)][static_cast<size_t>(Token::While)] = SymbolSequence{Rule::STMT, Rule::STMT_LIST_TAIL, };
	table[static_cast<size_t>(Rule::STMT_LIST)][static_cast<size_t>(Token::Do)] = SymbolSequence{Rule::STMT, Rule::STMT_LIST_TAIL, };
	table[static_cast<size_t>(Rule::STMT_LIST)][static_cast<size_t>(Token::Od)] = SymbolSequence{};
	table[static_cast<size_t>(Rule::STMT_LIST)][static_cast<size_t>(Token::Return)] = SymbolSequence{Rule::STMT, Rule::STMT_LIST_TAIL, };
	table[static_cast<size_t>(Rule::STMT_LIST)][static_cast<size_t>(Token::For)] = SymbolSequence{Rule::STMT, Rule::STMT_LIST_TAIL, };
	table[static_cast<size_t>(Rule::STMT_LIST)][static_cast<size_t>(Token::Until)] = SymbolSequence{};
	table[static_cast<size_t>(Rule::STMT_LIST_TAIL)][static_cast<size_t>(Token::End)] = SymbolSequence{};
	table[static_cast<size_t>(Rule::STMT_LIST_TAIL)][static_cast<size_t>(Token::Semicolon)] = SymbolSequence{Token::Semicolon, Rule::STMT_LIST, };
	table[static_cast<size_t>(Rule::STMT_LIST_TAIL)][static_cast<size_t>(Token::Fi)] = SymbolSequence{};
	table[static_cast<size_t>(Rule::STMT_LIST_TAIL)][static_cast<size_t>(Token::Else)] = SymbolSequence{};
	table[static_cast<size_t>(Rule::STMT_LIST_TAIL)][static_cast<size_t>(Token::Od)] = SymbolSequence{};
	table[static_cast<size_t>(Rule::STMT_LIST_TAIL)][static_cast<size_t>(Token::Until)] = SymbolSequence{};
	...
	table[static_cast<size_t>(Rule::OR_EXP)][static_cast<size_t>(Token::Identifier)] = SymbolSequence{Rule::AND_EXP, Rule::OR_EXP_TAIL, };
	table[static_cast<size_t>(Rule::OR_EXP)][static_cast<size_t>(Token::L_Paren)] = SymbolSequence{Rule::AND_EXP, Rule::OR_EXP_TAIL, };
	table[static_cast<size_t>(Rule::OR_EXP)][static_cast<size_t>(Token::Comparison)] = SymbolSequence{Rule::AND_EXP, Rule::OR_EXP_TAIL, };
	table[static_cast<size_t>(Rule::OR_EXP)][static_cast<size_t>(Token::New)] = SymbolSequence{Rule::AND_EXP, Rule::OR_EXP_TAIL, };
	table[static_cast<size_t>(Rule::OR_EXP)][static_cast<size_t>(Token::Ref)] = SymbolSequence{Rule::AND_EXP, Rule::OR_EXP_TAIL, };
	table[static_cast<size_t>(Rule::OR_EXP)][static_cast<size_t>(Token::Deref)] = SymbolSequence{Rule::AND_EXP, Rule::OR_EXP_TAIL, };
	table[static_cast<size_t>(Rule::OR_EXP)][static_cast<size_t>(Token::Float_L)] = SymbolSequence{Rule::AND_EXP, Rule::OR_EXP_TAIL, };
	table[static_cast<size_t>(Rule::OR_EXP)][static_cast<size_t>(Token::Int_L)] = SymbolSequence{Rule::AND_EXP, Rule::OR_EXP_TAIL, };
	table[static_cast<size_t>(Rule::OR_EXP)][static_cast<size_t>(Token::String_L)] = SymbolSequence{Rule::AND_EXP, Rule::OR_EXP_TAIL, };
	table[static_cast<size_t>(Rule::OR_EXP)][static_cast<size_t>(Token::Bool_L)] = SymbolSequence{Rule::AND_EXP, Rule::OR_EXP_TAIL, };
	table[static_cast<size_t>(Rule::OR_EXP)][static_cast<size_t>(Token::Null)] = SymbolSequence{Rule::AND_EXP, Rule::OR_EXP_TAIL, };
	table[static_cast<size_t>(Rule::OR_EXP_TAIL)][static_cast<size_t>(Token::End)] = SymbolSequence{};
	table[static_cast<size_t>(Rule::OR_EXP_TAIL)][static_cast<size_t>(Token::Semicolon)] = SymbolSequence{};
	table[static_cast<size_t>(Rule::OR_EXP_TAIL)][static_cast<size_t>(Token::In)] = SymbolSequence{};
	table[static_cast<size_t>(Rule::OR_EXP_TAIL)][static_cast<size_t>(Token::R_Paren)] = SymbolSequence{};
	table[static_cast<size_t>(Rule::OR_EXP_TAIL)][static_cast<size_t>(Token::Comma)] = SymbolSequence{};
	table[static_cast<size_t>(Rule::OR_EXP_TAIL)][static_cast<size_t>(Token::Or)] = SymbolSequence{Token::Or, Rule::AND_EXP, Rule::OR_EXP_TAIL, };
	table[static_cast<size_t>(Rule::OR_EXP_TAIL)][static_cast<size_t>(Token::Then)] = SymbolSequence{};
	table[static_cast<size_t>(Rule::OR_EXP_TAIL)][static_cast<size_t>(Token::Fi)] = SymbolSequence{};
	table[static_cast<size_t>(Rule::OR_EXP_TAIL)][static_cast<size_t>(Token::Else)] = SymbolSequence{};
	table[static_cast<size_t>(Rule::OR_EXP_TAIL)][static_cast<size_t>(Token::Do)] = SymbolSequence{};
	table[static_cast<size_t>(Rule::OR_EXP_TAIL)][static_cast<size_t>(Token::Od)] = SymbolSequence{};
	table[static_cast<size_t>(Rule::OR_EXP_TAIL)][static_cast<size_t>(Token::To)] = SymbolSequence{};
	table[static_cast<size_t>(Rule::OR_EXP_TAIL)][static_cast<size_t>(Token::Step)] = SymbolSequence{};
	table[static_cast<size_t>(Rule::OR_EXP_TAIL)][static_cast<size_t>(Token::Until)] = SymbolSequence{};
	table[static_cast<size_t>(Rule::AND_EXP)][static_cast<size_t>(Token::Identifier)] = SymbolSequence{Rule::REL_EXP, Rule::AND_EXP_TAIL, };
	table[static_cast<size_t>(Rule::AND_EXP)][static_cast<size_t>(Token::L_Paren)] = SymbolSequence{Rule::REL_EXP, Rule::AND_EXP_TAIL, };
	table[static_cast<size_t>(Rule::AND_EXP)][static_cast<size_t>(Token::Comparison)] = SymbolSequence{Rule::REL_EXP, Rule::AND_EXP_TAIL, };
	table[static_cast<size_t>(Rule::AND_EXP)][static_cast<size_t>(Token::New)] = SymbolSequence{Rule::REL_EXP, Rule::AND_EXP_TAIL, };
	table[static_cast<size_t>(Rule::AND_EXP)][static_cast<size_t>(Token::Ref)] = SymbolSequence{Rule::REL_EXP, Rule::AND_EXP_TAIL, };
	table[static_cast<size_t>(Rule::AND_EXP)][static_cast<size_t>(Token::Deref)] = SymbolSequence{Rule::REL_EXP, Rule::AND_EXP_TAIL, };
	table[static_cast<size_t>(Rule::AND_EXP)][static_cast<size_t>(Token::Float_L)] = SymbolSequence{Rule::REL_EXP, Rule::AND_EXP_TAIL, };
	table[static_cast<size_t>(Rule::AND_EXP)][static_cast<size_t>(Token::Int_L)] = SymbolSequence{Rule::REL_EXP, Rule::AND_EXP_TAIL, };
	table[static_cast<size_t>(Rule::AND_EXP)][static_cast<size_t>(Token::String_L)] = SymbolSequence{Rule::REL_EXP, Rule::AND_EXP_TAIL, };
	table[static_cast<size_t>(Rule::AND_EXP)][static_cast<size_t>(Token::Bool_L)] = SymbolSequence{Rule::REL_EXP, Rule::AND_EXP_TAIL, };
	table[static_cast<size_t>(Rule::AND_EXP)][static_cast<size_t>(Token::Null)] = SymbolSequence{Rule::REL_EXP, Rule::AND_EXP_TAIL, };
	table[static_cast<size_t>(Rule::AND_EXP_TAIL)][static_cast<size_t>(Token::End)] = SymbolSequence{};
	table[static_cast<size_t>(Rule::AND_EXP_TAIL)][static_cast<size_t>(Token::Semicolon)] = SymbolSequence{};
	table[static_cast<size_t>(Rule::AND_EXP_TAIL)][static_cast<size_t>(Token::In)] = SymbolSequence{};
	table[static_cast<size_t>(Rule::AND_EXP_TAIL)][static_cast<size_t>(Token::R_Paren)] = SymbolSequence{};
	table[static_cast<size_t>(Rule::AND_EXP_TAIL)][static_cast<size_t>(Token::Comma)] = SymbolSequence{};
	table[static_cast<size_t>(Rule::AND_EXP_TAIL)][static_cast<size_t>(Token::Or)] = SymbolSequence{};
	table[static_cast<size_t>(Rule::AND_EXP_TAIL)][static_cast<size_t>(Token::And)] = SymbolSequence{Token::And, Rule::REL_EXP, Rule::AND_EXP_TAIL, };
	table[static_cast<size_t>(Rule::AND_EXP_TAIL)][static_cast<size_t>(Token::Then)] = SymbolSequence{};
	table[static_cast<size_t>(Rule::AND_EXP_TAIL)][static_cast<size_t>(Token::Fi)] = SymbolSequence{};
	table[static_cast<size_t>(Rule::AND_EXP_TAIL)][static_cast<size_t>(Token::Else)] = SymbolSequence{};
	table[static_cast<size_t>(Rule::AND_EXP_TAIL)][static_cast<size_t>(Token::Do)] = SymbolSequence{};
	table[static_cast<size_t>(Rule::AND_EXP_TAIL)][static_cast<size_t>(Token::Od)] = SymbolSequence{};
	table[static_cast<size_t>(Rule::AND_EXP_TAIL)][static_cast<size_t>(Token::To)] = SymbolSequence{};
	table[static_cast<size_t>(Rule::AND_EXP_TAIL)][static_cast<size_t>(Token::Step)] = SymbolSequence{};
	table[static_cast<size_t>(Rule::AND_EXP_TAIL)][static_cast<size_t>(Token::Until)] = SymbolSequence{};
	table[static_cast<size_t>(Rule::REL_EXP)][static_cast<size_t>(Token::Identifier)] = SymbolSequence{Rule::ADD_EXP, Rule::REL_EXP_TAIL, };
	table[static_cast<size_t>(Rule::REL_EXP)][static_cast<size_t>(Token::L_Paren)] = SymbolSequence{Rule::ADD_EXP, Rule::REL_EXP_TAIL, };
	table[static_cast<size_t>(Rule::REL_EXP)][static_cast<size_t>(Token::Comparison)] = SymbolSequence{Rule::ADD_EXP, Rule::REL_EXP_TAIL, };
	table[static_cast<size_t>(Rule::REL_EXP)][static_cast<size_t>(Token::New)] = SymbolSequence{Rule::ADD_EXP, Rule::REL_EXP_TAIL, };
	table[static_cast<size_t>(Rule::REL_EXP)][static_cast<size_t>(Token::Ref)] = SymbolSequence{Rule::ADD_EXP, Rule::REL_EXP_TAIL, };
	table[static_cast<size_t>(Rule::REL_EXP)][static_cast<size_t>(Token::Deref)] = SymbolSequence{Rule::ADD_EXP, Rule::REL_EXP_TAIL, };
	table[static_cast<size_t>(Rule::REL_EXP)][static_cast<size_t>(Token::Float_L)] = SymbolSequence{Rule::ADD_EXP, Rule::REL_EXP_TAIL, };
	table[static_cast<size_t>(Rule::REL_EXP)][static_cast<size_t>(Token::Int_L)] = SymbolSequence{Rule::ADD_EXP, Rule::REL_EXP_TAIL, };
	table[static_cast<size_t>(Rule::REL_EXP)][static_cast<size_t>(Token::String_L)] = SymbolSequence{Rule::ADD_EXP, Rule::REL_EXP_TAIL, };
	table[static_cast<size_t>(Rule::REL_EXP)][static_cast<size_t>(Token::Bool_L)] = SymbolSequence{Rule::ADD_EXP, Rule::REL_EXP_TAIL, };
	table[static_cast<size_t>(Rule::REL_EXP)][static_cast<size_t>(Token::Null)] = SymbolSequence{Rule::ADD_EXP, Rule::REL_EXP_TAIL, };
	table[static_cast<size_t>(Rule::REL_EXP_TAIL)][static_cast<size_t>(Token::End)] = SymbolSequence{};
	table[static_cast<size_t>(Rule::REL_EXP_TAIL)][static_cast<size_t>(Token::Semicolon)] = SymbolSequence{};
	table[static_cast<size_t>(Rule::REL_EXP_TAIL)][static_cast<size_t>(Token::In)] = SymbolSequence{};
	table[static_cast<size_t>(Rule::REL_EXP_TAIL)][static_cast<size_t>(Token::R_Paren)] = SymbolSequence{};
	table[static_cast<size_t>(Rule::REL_EXP_TAIL)][static_cast<size_t>(Token::Comma)] = SymbolSequence{};
	table[static_cast<size_t>(Rule::REL_EXP_TAIL)][static_cast<size_t>(Token::Or)] = SymbolSequence{};
	table[static_cast<size_t>(Rule::REL_EXP_TAIL)][static_cast<size_t>(Token::And)] = SymbolSequence{};
	table[static_cast<size_t>(Rule::REL_EXP_TAIL)][static_cast<size_t>(Token::Comparison)] = SymbolSequence{Rule::REL_OP, Rule::ADD_EXP, Rule::REL_EXP_TAIL, };
	table[static_cast<size_t>(Rule::REL_EXP_TAIL)][static_cast<size_t>(Token::Comparison)] = SymbolSequence{Rule::REL_OP, Rule::ADD_EXP, Rule::REL_EXP_TAIL, };
	table[static_cast<size_t>(Rule::REL_EXP_TAIL)][static_cast<size_t>(Token::Comparison)] = SymbolSequence{Rule::REL_OP, Rule::ADD_EXP, Rule::REL_EXP_TAIL, };
	table[static_cast<size_t>(Rule::REL_EXP_TAIL)][static_cast<size_t>(Token::Comparison)] = SymbolSequence{Rule::REL_OP, Rule::ADD_EXP, Rule::REL_EXP_TAIL, };
	table[static_cast<size_t>(Rule::REL_EXP_TAIL)][static_cast<size_t>(Token::Comparison)] = SymbolSequence{Rule::REL_OP, Rule::ADD_EXP, Rule::REL_EXP_TAIL, };
	table[static_cast<size_t>(Rule::REL_EXP_TAIL)][static_cast<size_t>(Token::Comparison)] = SymbolSequence{Rule::REL_OP, Rule::ADD_EXP, Rule::REL_EXP_TAIL, };
	table[static_cast<size_t>(Rule::REL_EXP_TAIL)][static_cast<size_t>(Token::Then)] = SymbolSequence{};
	table[static_cast<size_t>(Rule::REL_EXP_TAIL)][static_cast<size_t>(Token::Fi)] = SymbolSequence{};
	table[static_cast<size_t>(Rule::REL_EXP_TAIL)][static_cast<size_t>(Token::Else)] = SymbolSequence{};
	table[static_cast<size_t>(Rule::REL_EXP_TAIL)][static_cast<size_t>(Token::Do)] = SymbolSequence{};
	table[static_cast<size_t>(Rule::REL_EXP_TAIL)][static_cast<size_t>(Token::Od)] = SymbolSequence{};
	table[static_cast<size_t>(Rule::REL_EXP_TAIL)][static_cast<size_t>(Token::To)] = SymbolSequence{};
	table[static_cast<size_t>(Rule::REL_EXP_TAIL)][static_cast<size_t>(Token::Step)] = SymbolSequence{};
	table[static_cast<size_t>(Rule::REL_EXP_TAIL)][static_cast<size_t>(Token::Until)] = SymbolSequence{};
	table[static_cast<size_t>(Rule::ADD_EXP)][static_cast<size_t>(Token::Identifier)] = SymbolSequence{Rule::MUL_EXP, Rule::ADD_EXP_TAIL, };
	table[static_cast<size_t>(Rule::ADD_EXP)][static_cast<size_t>(Token::L_Paren)] = SymbolSequence{Rule::MUL_EXP, Rule::ADD_EXP_TAIL, };
	table[static_cast<size_t>(Rule::ADD_EXP)][static_cast<size_t>(Token::Comparison)] = SymbolSequence{Rule::MUL_EXP, Rule::ADD_EXP_TAIL, };
	table[static_cast<size_t>(Rule::ADD_EXP)][static_cast<size_t>(Token::New)] = SymbolSequence{Rule::MUL_EXP, Rule::ADD_EXP_TAIL, };
	table[static_cast<size_t>(Rule::ADD_EXP)][static_cast<size_t>(Token::Ref)] = SymbolSequence{Rule::MUL_EXP, Rule::ADD_EXP_TAIL, };
	table[static_cast<size_t>(Rule::ADD_EXP)][static_cast<size_t>(Token::Deref)] = SymbolSequence{Rule::MUL_EXP, Rule::ADD_EXP_TAIL, };
	table[static_cast<size_t>(Rule::ADD_EXP)][static_cast<size_t>(Token::Float_L)] = SymbolSequence{Rule::MUL_EXP, Rule::ADD_EXP_TAIL, };
	table[static_cast<size_t>(Rule::ADD_EXP)][static_cast<size_t>(Token::Int_L)] = SymbolSequence{Rule::MUL_EXP, Rule::ADD_EXP_TAIL, };
	table[static_cast<size_t>(Rule::ADD_EXP)][static_cast<size_t>(Token::String_L)] = SymbolSequence{Rule::MUL_EXP, Rule::ADD_EXP_TAIL, };
	table[static_cast<size_t>(Rule::ADD_EXP)][static_cast<size_t>(Token::Bool_L)] = SymbolSequence{Rule::MUL_EXP, Rule::ADD_EXP_TAIL, };
	table[static_cast<size_t>(Rule::ADD_EXP)][static_cast<size_t>(Token::Null)] = SymbolSequence{Rule::MUL_EXP, Rule::ADD_EXP_TAIL, };
	table[static_cast<size_t>(Rule::ADD_EXP_TAIL)][static_cast<size_t>(Token::End)] = SymbolSequence{};
	table[static_cast<size_t>(Rule::ADD_EXP_TAIL)][static_cast<size_t>(Token::Semicolon)] = SymbolSequence{};
	table[static_cast<size_t>(Rule::ADD_EXP_TAIL)][static_cast<size_t>(Token::In)] = SymbolSequence{};
	table[static_cast<size_t>(Rule::ADD_EXP_TAIL)][static_cast<size_t>(Token::R_Paren)] = SymbolSequence{};
	table[static_cast<size_t>(Rule::ADD_EXP_TAIL)][static_cast<size_t>(Token::Comma)] = SymbolSequence{};
	table[static_cast<size_t>(Rule::ADD_EXP_TAIL)][static_cast<size_t>(Token::Or)] = SymbolSequence{};
	table[static_cast<size_t>(Rule::ADD_EXP_TAIL)][static_cast<size_t>(Token::And)] = SymbolSequence{};
	table[static_cast<size_t>(Rule::ADD_EXP_TAIL)][static_cast<size_t>(Token::Plus)] = SymbolSequence{Rule::SUMINUS, Rule::MUL_EXP, Rule::ADD_EXP_TAIL, };
	table[static_cast<size_t>(Rule::ADD_EXP_TAIL)][static_cast<size_t>(Token::Minus)] = SymbolSequence{Rule::SUMINUS, Rule::MUL_EXP, Rule::ADD_EXP_TAIL, };
	table[static_cast<size_t>(Rule::ADD_EXP_TAIL)][static_cast<size_t>(Token::Comparison)] = SymbolSequence{};
	table[static_cast<size_t>(Rule::ADD_EXP_TAIL)][static_cast<size_t>(Token::Comparison)] = SymbolSequence{};
	table[static_cast<size_t>(Rule::ADD_EXP_TAIL)][static_cast<size_t>(Token::Comparison)] = SymbolSequence{};
	table[static_cast<size_t>(Rule::ADD_EXP_TAIL)][static_cast<size_t>(Token::Comparison)] = SymbolSequence{};
	table[static_cast<size_t>(Rule::ADD_EXP_TAIL)][static_cast<size_t>(Token::Comparison)] = SymbolSequence{};
	table[static_cast<size_t>(Rule::ADD_EXP_TAIL)][static_cast<size_t>(Token::Comparison)] = SymbolSequence{};
	table[static_cast<size_t>(Rule::ADD_EXP_TAIL)][static_cast<size_t>(Token::Then)] = SymbolSequence{};
	table[static_cast<size_t>(Rule::ADD_EXP_TAIL)][static_cast<size_t>(Token::Fi)] = SymbolSequence{};
	table[static_cast<size_t>(Rule::ADD_EXP_TAIL)][static_cast<size_t>(Token::Else)] = SymbolSequence{};
	table[static_cast<size_t>(Rule::ADD_EXP_TAIL)][static_cast<size_t>(Token::Do)] = SymbolSequence{};
	table[static_cast<size_t>(Rule::ADD_EXP_TAIL)][static_cast<size_t>(Token::Od)] = SymbolSequence{};
	table[static_cast<size_t>(Rule::ADD_EXP_TAIL)][static_cast<size_t>(Token::To)] = SymbolSequence{};
	table[static_cast<size_t>(Rule::ADD_EXP_TAIL)][static_cast<size_t>(Token::Step)] = SymbolSequence{};
	table[static_cast<size_t>(Rule::ADD_EXP_TAIL)][static_cast<size_t>(Token::Until)] = SymbolSequence{};
	table[static_cast<size_t>(Rule::MUL_EXP)][static_cast<size_t>(Token::Identifier)] = SymbolSequence{Rule::POW_EXP, Rule::MUL_EXP_TAIL, };
	table[static_cast<size_t>(Rule::MUL_EXP)][static_cast<size_t>(Token::L_Paren)] = SymbolSequence{Rule::POW_EXP, Rule::MUL_EXP_TAIL, };
	table[static_cast<size_t>(Rule::MUL_EXP)][static_cast<size_t>(Token::Comparison)] = SymbolSequence{Rule::POW_EXP, Rule::MUL_EXP_TAIL, };
	table[static_cast<size_t>(Rule::MUL_EXP)][static_cast<size_t>(Token::New)] = SymbolSequence{Rule::POW_EXP, Rule::MUL_EXP_TAIL, };
	table[static_cast<size_t>(Rule::MUL_EXP)][static_cast<size_t>(Token::Ref)] = SymbolSequence{Rule::POW_EXP, Rule::MUL_EXP_TAIL, };
	table[static_cast<size_t>(Rule::MUL_EXP)][static_cast<size_t>(Token::Deref)] = SymbolSequence{Rule::POW_EXP, Rule::MUL_EXP_TAIL, };
	table[static_cast<size_t>(Rule::MUL_EXP)][static_cast<size_t>(Token::Float_L)] = SymbolSequence{Rule::POW_EXP, Rule::MUL_EXP_TAIL, };
	table[static_cast<size_t>(Rule::MUL_EXP)][static_cast<size_t>(Token::Int_L)] = SymbolSequence{Rule::POW_EXP, Rule::MUL_EXP_TAIL, };
	table[static_cast<size_t>(Rule::MUL_EXP)][static_cast<size_t>(Token::String_L)] = SymbolSequence{Rule::POW_EXP, Rule::MUL_EXP_TAIL, };
	table[static_cast<size_t>(Rule::MUL_EXP)][static_cast<size_t>(Token::Bool_L)] = SymbolSequence{Rule::POW_EXP, Rule::MUL_EXP_TAIL, };
	table[static_cast<size_t>(Rule::MUL_EXP)][static_cast<size_t>(Token::Null)] = SymbolSequence{Rule::POW_EXP, Rule::MUL_EXP_TAIL, };
	table[static_cast<size_t>(Rule::MUL_EXP_TAIL)][static_cast<size_t>(Token::End)] = SymbolSequence{};
	table[static_cast<size_t>(Rule::MUL_EXP_TAIL)][static_cast<size_t>(Token::Semicolon)] = SymbolSequence{};
	table[static_cast<size_t>(Rule::MUL_EXP_TAIL)][static_cast<size_t>(Token::In)] = SymbolSequence{};
	table[static_cast<size_t>(Rule::MUL_EXP_TAIL)][static_cast<size_t>(Token::R_Paren)] = SymbolSequence{};
	table[static_cast<size_t>(Rule::MUL_EXP_TAIL)][static_cast<size_t>(Token::Comma)] = SymbolSequence{};
	table[static_cast<size_t>(Rule::MUL_EXP_TAIL)][static_cast<size_t>(Token::Or)] = SymbolSequence{};
	table[static_cast<size_t>(Rule::MUL_EXP_TAIL)][static_cast<size_t>(Token::And)] = SymbolSequence{};
	table[static_cast<size_t>(Rule::MUL_EXP_TAIL)][static_cast<size_t>(Token::Plus)] = SymbolSequence{};
	table[static_cast<size_t>(Rule::MUL_EXP_TAIL)][static_cast<size_t>(Token::Minus)] = SymbolSequence{};
	table[static_cast<size_t>(Rule::MUL_EXP_TAIL)][static_cast<size_t>(Token::Times)] = SymbolSequence{Rule::MULDIV, Rule::POW_EXP, Rule::MUL_EXP_TAIL, };
	table[static_cast<size_t>(Rule::MUL_EXP_TAIL)][static_cast<size_t>(Token::Divides)] = SymbolSequence{Rule::MULDIV, Rule::POW_EXP, Rule::MUL_EXP_TAIL, };
	table[static_cast<size_t>(Rule::MUL_EXP_TAIL)][static_cast<size_t>(Token::Comparison)] = SymbolSequence{};
	table[static_cast<size_t>(Rule::MUL_EXP_TAIL)][static_cast<size_t>(Token::Comparison)] = SymbolSequence{};
	table[static_cast<size_t>(Rule::MUL_EXP_TAIL)][static_cast<size_t>(Token::Comparison)] = SymbolSequence{};
	table[static_cast<size_t>(Rule::MUL_EXP_TAIL)][static_cast<size_t>(Token::Comparison)] = SymbolSequence{};
	table[static_cast<size_t>(Rule::MUL_EXP_TAIL)][static_cast<size_t>(Token::Comparison)] = SymbolSequence{};
	table[static_cast<size_t>(Rule::MUL_EXP_TAIL)][static_cast<size_t>(Token::Comparison)] = SymbolSequence{};
	table[static_cast<size_t>(Rule::MUL_EXP_TAIL)][static_cast<size_t>(Token::Then)] = SymbolSequence{};
	table[static_cast<size_t>(Rule::MUL_EXP_TAIL)][static_cast<size_t>(Token::Fi)] = SymbolSequence{};
	table[static_cast<size_t>(Rule::MUL_EXP_TAIL)][static_cast<size_t>(Token::Else)] = SymbolSequence{};
	table[static_cast<size_t>(Rule::MUL_EXP_TAIL)][static_cast<size_t>(Token::Do)] = SymbolSequence{};
	table[static_cast<size_t>(Rule::MUL_EXP_TAIL)][static_cast<size_t>(Token::Od)] = SymbolSequence{};
	table[static_cast<size_t>(Rule::MUL_EXP_TAIL)][static_cast<size_t>(Token::To)] = SymbolSequence{};
	table[static_cast<size_t>(Rule::MUL_EXP_TAIL)][static_cast<size_t>(Token::Step)] = SymbolSequence{};
	table[static_cast<size_t>(Rule::MUL_EXP_TAIL)][static_cast<size_t>(Token::Until)] = SymbolSequence{};
	table[static_cast<size_t>(Rule::POW_EXP)][static_cast<size_t>(Token::Identifier)] = SymbolSequence{Rule::UNARY_EXP, Rule::POW_EXP_TAIL, };
	table[static_cast<size_t>(Rule::POW_EXP)][static_cast<size_t>(Token::L_Paren)] = SymbolSequence{Rule::UNARY_EXP, Rule::POW_EXP_TAIL, };
	table[static_cast<size_t>(Rule::POW_EXP)][static_cast<size_t>(Token::Comparison)] = SymbolSequence{Rule::UNARY_EXP, Rule::POW_EXP_TAIL, };
	table[static_cast<size_t>(Rule::POW_EXP)][static_cast<size_t>(Token::New)] = SymbolSequence{Rule::UNARY_EXP, Rule::POW_EXP_TAIL, };
	table[static_cast<size_t>(Rule::POW_EXP)][static_cast<size_t>(Token::Ref)] = SymbolSequence{Rule::UNARY_EXP, Rule::POW_EXP_TAIL, };
	table[static_cast<size_t>(Rule::POW_EXP)][static_cast<size_t>(Token::Deref)] = SymbolSequence{Rule::UNARY_EXP, Rule::POW_EXP_TAIL, };
	table[static_cast<size_t>(Rule::POW_EXP)][static_cast<size_t>(Token::Float_L)] = SymbolSequence{Rule::UNARY_EXP, Rule::POW_EXP_TAIL, };
	table[static_cast<size_t>(Rule::POW_EXP)][static_cast<size_t>(Token::Int_L)] = SymbolSequence{Rule::UNARY_EXP, Rule::POW_EXP_TAIL, };
	table[static_cast<size_t>(Rule::POW_EXP)][static_cast<size_t>(Token::String_L)] = SymbolSequence{Rule::UNARY_EXP, Rule::POW_EXP_TAIL, };
	table[static_cast<size_t>(Rule::POW_EXP)][static_cast<size_t>(Token::Bool_L)] = SymbolSequence{Rule::UNARY_EXP, Rule::POW_EXP_TAIL, };
	table[static_cast<size_t>(Rule::POW_EXP)][static_cast<size_t>(Token::Null)] = SymbolSequence{Rule::UNARY_EXP, Rule::POW_EXP_TAIL, };
	table[static_cast<size_t>(Rule::POW_EXP_TAIL)][static_cast<size_t>(Token::End)] = SymbolSequence{};
	table[static_cast<size_t>(Rule::POW_EXP_TAIL)][static_cast<size_t>(Token::Semicolon)] = SymbolSequence{};
	table[static_cast<size_t>(Rule::POW_EXP_TAIL)][static_cast<size_t>(Token::In)] = SymbolSequence{};
	table[static_cast<size_t>(Rule::POW_EXP_TAIL)][static_cast<size_t>(Token::R_Paren)] = SymbolSequence{};
	table[static_cast<size_t>(Rule::POW_EXP_TAIL)][static_cast<size_t>(Token::Comma)] = SymbolSequence{};
	table[static_cast<size_t>(Rule::POW_EXP_TAIL)][static_cast<size_t>(Token::Or)] = SymbolSequence{};
	table[static_cast<size_t>(Rule::POW_EXP_TAIL)][static_cast<size_t>(Token::And)] = SymbolSequence{};
	table[static_cast<size_t>(Rule::POW_EXP_TAIL)][static_cast<size_t>(Token::Pow)] = SymbolSequence{Token::Pow, Rule::UNARY_EXP, Rule::POW_EXP_TAIL, };
	table[static_cast<size_t>(Rule::POW_EXP_TAIL)][static_cast<size_t>(Token::Plus)] = SymbolSequence{};
	table[static_cast<size_t>(Rule::POW_EXP_TAIL)][static_cast<size_t>(Token::Minus)] = SymbolSequence{};
	table[static_cast<size_t>(Rule::POW_EXP_TAIL)][static_cast<size_t>(Token::Times)] = SymbolSequence{};
	table[static_cast<size_t>(Rule::POW_EXP_TAIL)][static_cast<size_t>(Token::Divides)] = SymbolSequence{};
	table[static_cast<size_t>(Rule::POW_EXP_TAIL)][static_cast<size_t>(Token::Comparison)] = SymbolSequence{};
	table[static_cast<size_t>(Rule::POW_EXP_TAIL)][static_cast<size_t>(Token::Comparison)] = SymbolSequence{};
	table[static_cast<size_t>(Rule::POW_EXP_TAIL)][static_cast<size_t>(Token::Comparison)] = SymbolSequence{};
	table[static_cast<size_t>(Rule::POW_EXP_TAIL)][static_cast<size_t>(Token::Comparison)] = SymbolSequence{};
	table[static_cast<size_t>(Rule::POW_EXP_TAIL)][static_cast<size_t>(Token::Comparison)] = SymbolSequence{};
	table[static_cast<size_t>(Rule::POW_EXP_TAIL)][static_cast<size_t>(Token::Comparison)] = SymbolSequence{};
	table[static_cast<size_t>(Rule::POW_EXP_TAIL)][static_cast<size_t>(Token::Then)] = SymbolSequence{};
	table[static_cast<size_t>(Rule::POW_EXP_TAIL)][static_cast<size_t>(Token::Fi)] = SymbolSequence{};
	table[static_cast<size_t>(Rule::POW_EXP_TAIL)][static_cast<size_t>(Token::Else)] = SymbolSequence{};
	table[static_cast<size_t>(Rule::POW_EXP_TAIL)][static_cast<size_t>(Token::Do)] = SymbolSequence{};
	table[static_cast<size_t>(Rule::POW_EXP_TAIL)][static_cast<size_t>(Token::Od)] = SymbolSequence{};
	table[static_cast<size_t>(Rule::POW_EXP_TAIL)][static_cast<size_t>(Token::To)] = SymbolSequence{};
	table[static_cast<size_t>(Rule::POW_EXP_TAIL)][static_cast<size_t>(Token::Step)] = SymbolSequence{};
	table[static_cast<size_t>(Rule::POW_EXP_TAIL)][static_cast<size_t>(Token::Until)] = SymbolSequence{};
